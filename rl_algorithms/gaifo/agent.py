...
from rl_algorithms.common.buffer.gail_buffer import GAIfOBuffer
from rl_algorithms.common.helper_functions import numpy2floattensor
from rl_algorithms.gail.agent import GAILPPOAgent
...
class GAIfOAgent(GAILPPOAgent):
    """GAIL from observation Agent.
    See: https://arxiv.org/pdf/1807.06158.pdf
    ...
    def __init__(
        ...
        self.demo_memory = GAIfOBuffer(self.hyper_params.demo_path)
    ...
    def step(
        ...
        self.next_states.append(numpy2floattensor(next_state, self.learner.device))
                ...
                gail_reward = compute_gail_reward(
                    self.learner.discriminator(
                        (
                            ...
                            numpy2floattensor(next_state, self.learner.device),
                        )
                    )
                )
