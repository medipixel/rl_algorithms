...
agent = dict(
    ...
    hyper_params=dict(
        ...
        save_dir="./data/",
        dataset_path=[
            "data/offline_data/BiorobotPhantom/lad2/offline/",
            "data/offline_data/BiorobotPhantom/lad3/offline/",
            "data/offline_data/BiorobotPhantom/lcx1/offline/",
            "data/offline_data/BiorobotPhantom/rca2/offline/",
            "data/offline_data/BiorobotPhantom/rca3/offline/",
        ],
    ),
    learner_cfg=dict(
        type="DQNLearner",
