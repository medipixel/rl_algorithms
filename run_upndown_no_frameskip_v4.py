# -*- coding: utf-8 -*-
"""Train or test algorithms on UpNDownNoFrameskip-v4.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--cfg-path",
        type=str,
        default="configs/upndown_no_frameskip_v4/iqn.py",
        help="config path",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--episode-num", type=int, default=200000000, help="total episode num"
    )
    parser.add_argument(
